...
TRAIN_IMAGE_FOLDER  = "./train_images/berserk/"
TEXT_IMAGE_FOLDER   = "./text_images/berserk/"
...
def predict(path: str) -> None:
    with open(MODELS_PATH + "multilayer_13x13_berserk", "rb") as f:
        model = pickle.load(f)
